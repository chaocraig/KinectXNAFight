...
namespace PongImproved
{
    ...
    public class G3DBox : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public override void Initialize()
        {
            ...
            vertices[1] = new VertexPositionColor(new Vector3(-1.0f, 1.0f, -1.0f), Color.White);
            vertices[2] = new VertexPositionColor(new Vector3(1.0f, 1.0f, -1.0f), Color.White);
            vertices[3] = new VertexPositionColor(new Vector3(1.0f, -1.0f, -1.0f), Color.White);

            // 前面四個點
            vertices[4] = new VertexPositionColor(new Vector3(-1.0f, -1.0f, 1.0f), Color.White);
            vertices[5] = new VertexPositionColor(new Vector3(-1.0f, 1.0f, 1.0f), Color.White);
            vertices[6] = new VertexPositionColor(new Vector3(1.0f, 1.0f, 1.0f), Color.White);
            vertices[7] = new VertexPositionColor(new Vector3(1.0f, -1.0f, 1.0f), Color.White);
            ...
            indexBuffer = new IndexBuffer(game.GraphicsDevice,
                                          ...
                                          BufferUsage.WriteOnly);  // 產生 頂點索引緩衝區
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            effect.DiffuseColor = color;  // color is here <<=========

            game.GraphicsDevice.SetVertexBuffer(vertexBuffer);
            game.GraphicsDevice.Indices = indexBuffer;

            RasterizerState rasterizerState = new RasterizerState();
            rasterizerState.FillMode = FillMode.Solid;  //.WireFrame
            rasterizerState.CullMode = CullMode.None; // <======= 正反面都要呈現
